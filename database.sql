...
SELECT city FROM accounts WHERE city = 'chicago';
...
SET 
	account_balance = 10
WHERE 
	transactions_attempted = 0 AND account_balance = 0.00;
...
VALUES
	('sharmarke', 'minneapolis', 15, 20, 35500000.80);
...
FROM 
	accounts 
WHERE
	(city = 'miami' OR city = 'phoenix') AND transactions_completed < 5;
